...
def test_portfolio_turnover_exiting_positions():
    ...
    # A exits, B enters, C is unchanged.
...
def test_get_estimation_window_excludes_application_month():
    ...
    # Extreme application-month return should not affect mu.
